...
-- selecciona todas las columnas de la tabla 'users' donde el 'email' sea igual a 'educa@gmail.com' ordenados decendente por 'age'.
SELECT * FROM users WHERE email='educa@gmail.com' ORDER BY age DESC;

-- selecciona la columna 'name' de la tabla 'users' donde el 'email' sea igual a 'educa@gmail.com' ordenados decendente por 'age'.
